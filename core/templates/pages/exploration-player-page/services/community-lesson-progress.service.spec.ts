...
import { CommunityLessonProgressService, CommunityLessonProgressEvent } from './community-lesson-progress.service';
...
describe('CommunityLessonProgressService', () => {
  ...
  it('should emit progress updates', (done) => {
    const event: CommunityLessonProgressEvent = { lessonId: 'lesson1', checkpoint: 1 };
  ...
  it('should emit new event if checkpoint changes', () => {
    const event1: CommunityLessonProgressEvent = { lessonId: 'lesson1', checkpoint: 1 };
    const event2: CommunityLessonProgressEvent = { lessonId: 'lesson1', checkpoint: 2 };
