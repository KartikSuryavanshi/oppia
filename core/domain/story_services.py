            ...
            if change.cmd == story_domain.CMD_ADD_STORY_NODE:
                ...
                if (
                    ...
                    update_node_planned_publication_date_cmd = cast(
                        story_domain.UpdateStoryNodePropertyPlannedPublicationDateCmd,
                        change,
                    )
                    ...
                    update_node_first_publication_date_cmd = cast(
                        story_domain.UpdateStoryNodePropertyFirstPublicationDateCmd,
                        change,
                    )
                    ...
                    update_node_unpublishing_reason_cmd = cast(
                        story_domain.UpdateStoryNodePropertyUnpublishingReasonCmd,
                        change,
                    )
...
def populate_story_summary_model_fields(
    ...
    story_summary_dict = {
        ...
        'story_model_last_updated': (story_summary.story_model_last_updated),
        'story_model_created_on': (story_summary.story_model_created_on),
    }
